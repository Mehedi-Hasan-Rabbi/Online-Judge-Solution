...
void solve()
{
    ...
    if (a == b) cout << 0 << endl;
        ...
        else if (a % 2 == 0  and b % 2 == 0) cout << 2 << endl;

        else if (a % 2 == 1  and b % 2 == 1) cout << 2 << endl;
        else if (a % 2 == 1  and b % 2 == 0) cout << 1 << endl;
    }
    else {
        if (a % 2 == 1  and b % 2 == 0) cout << 2 << endl;
        else if (a % 2 == 1  and b % 2 == 1) cout << 1 << endl;

        else if (a % 2 == 0  and b % 2 == 0) cout << 1 << endl;
        else if (a % 2 == 0  and b % 2 == 1) cout << 2 << endl;
    }
}
