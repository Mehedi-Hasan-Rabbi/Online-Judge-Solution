...
void solve()
{
    ...
    for (int i = 1; i <= n; i++) {
        if (freqL[i] == 1) single.push_back(i);
        if (freqL[i] == 2) doubleL.push_back(i);
    }
    for (int i = 1; i <= n; i++) {
        if (freqR[i] == 1) single.push_back(i);
        if (freqR[i] == 2) doubleR.push_back(i);
    }
    ...
    while (k--) {
        L.push_back(single.back());
        R.push_back(single.back());
